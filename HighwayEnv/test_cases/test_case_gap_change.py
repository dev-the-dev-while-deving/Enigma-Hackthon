...
env = gym.make("highway-v0", render_mode="human", config={
    ...
    "vehicles_count": 10,         # Fewer vehicles to create large stable gaps
    "vehicles_density": 0.5,      # Lower density enforces >= 4s gaps
    "initial_spacing": 2.5,       # Spread out the spawns for stability
    "collision_reward": -50,   
    "high_speed_reward": 1,    
    "right_lane_reward": 0.1,  
    "reward_speed_range": [23.6, 30.5], # Roughly 85 km/h to 110 km/h
    "observation": {
        "type": "Kinematics",
        "noise": 0.05,            # Mild uncertainty injection (sensor noise)
