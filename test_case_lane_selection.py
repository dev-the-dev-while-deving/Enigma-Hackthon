...
env = gym.make("highway-v0", render_mode="human", config={
    ...
    "lanes_count": 3,             # Upgraded to 3 Lanes!
    "duration": 10000000,        
    "simulation_frequency": 15,
    "vehicles_count": 35,         # Dense traffic spread across 3 lanes
    "vehicles_density": 1.2,      # Medium-High density
    "initial_spacing": 2.5,       
    "collision_reward": -50,   
    "high_speed_reward": 1.5,     # Heavily reward finding the fastest lane
    "right_lane_reward": 0.0,     # Disable right-lane bias so it naturally searches for speed
    "reward_speed_range": [25.0, 31.0], # 90 km/h to 110 km/h
    "observation": {
        "type": "Kinematics",
